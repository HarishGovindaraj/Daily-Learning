...
export default function Turnstile({ onSuccess, onExpire }) {
  const containerRef = useRef(null);
  
  // Use VITE_TURNSTILE_SITE_KEY if configured, otherwise fall back to Cloudflare's always-pass testing site key
